...
export default class Door implements IScript<Props> {
  Clip = new AudioClip("49e34ab8-1f15-4f6d-b58a-dd95340c941e/sounds/Blender.mp3")
...
toggle(entity: Entity) {
  ...
  spawn(host: Entity, props: Props, channel: IChannel) {
    ...
    car.addComponent(new GLTFShape("49e34ab8-1f15-4f6d-b58a-dd95340c941e/models/Blender.glb"))
